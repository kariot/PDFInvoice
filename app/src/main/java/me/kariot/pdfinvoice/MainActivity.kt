...
class MainActivity : AppCompatActivity() {
    ...
    val BILL_DETAILS_TOP_PADDING = 70f
            ...
            .withPermissions(
                ...
                override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                    if (report.areAllPermissionsGranted()) {
                        ...
                        val outPath =
                            getExternalFilesDir(null).toString() + "/zzzzzzzzzzzzzzzzzzzz.pdf" //location where the pdf will store
                        Log.d("loc", outPath)
                        ...
                        for (i in 1..6) {
                            ...
                            val itemName = PdfPCell(Phrase("Item$i", appFontRegular))
                            itemName.border = Rectangle.NO_BORDER
                            val itemDesc = PdfPCell(Phrase("Description $i", appFontLight))
                            ...
                            val quantityCell = PdfPCell(Phrase("Quantity", appFontRegular))
                            ...
                            val disAmount = PdfPCell(Phrase("DIS. Amount", appFontRegular))
                            ...
                            val vat = PdfPCell(Phrase("VAT %", appFontRegular))
                            ...
                            val netAmount = PdfPCell(Phrase("Net Amount", appFontRegular))
    ...
    private fun addLine(doc: Document, writer: PdfWriter) {
    ...
    private fun initBillDetails(doc: Document) {
        ...
        val clientAddressCell1 = PdfPCell(
            Paragraph(
                "Aeth Analytica Private Limited",
                appFontRegular
            )
        )
        ...
        val invoiceNumber = PdfPCell(Phrase("BMC00123", appFontRegular))
        ...
        val totalAomountCell = PdfPCell(Phrase("AED 1234.00", appFontSemiBold))
    ...
    private fun initInvoiceHeader(doc: Document) {
        val d = resources.getDrawable(R.drawable.img_app_logo)
        ...
        var cell = PdfPCell(Image.getInstance(image)) // Logo Cell
        cell.border = Rectangle.NO_BORDER // Removes border
        cell.paddingTop = TABLE_TOP_PADDING // sets padding
        cell.paddingRight = TABLE_TOP_PADDING
        cell.paddingLeft = TABLE_TOP_PADDING
        ...
        var emailCellCell = PdfPCell(Phrase("abc@gmail.com", appFontRegular))
        ...
        var webCell = PdfPCell(Phrase("www.test.com", appFontRegular))
        ...
        var line2 = PdfPCell(Paragraph("2nd Floor, KSIDC BIC", appFontRegular))
        ...
        var line3 = PdfPCell(Paragraph("UL Cyber park", appFontRegular))
